...
class providerModel{
    ...
    function check(){
        $sql = "select * from provider where provider_email=:email";
    ...
    function addToken(){
        $sql = "update provider set token=:token where provider_email=:email";
    ...
    function set_newPW(){
        $sql = "update provider set password=:password where provider_email=:email and token=:token";
