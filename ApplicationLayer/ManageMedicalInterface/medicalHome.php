  ...
  <div class="card card-5">
    ...
    <div class="card-body">
      ...
      if ($_SESSION['usergroup'] == 1) {
        ...
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="medicineList.php">Medicine List</a></button>
          </center>
        </div>
        <?php
        ...
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="addMedicine.php">Add Medicine</a></button>
          </center>
        </div>
        <br></br>
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="medicineList.php">Manage Medicine</a></button>
          </center>
        </div> 
        <?php
        ...
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="medicineDelivery.php">Manage Medical Delivery</a></button>
          </center>
        </div> 
        <?php
      } ?>
